            ...
            <?php
                if(isset($_SESSION['user'])) {
                    echo '<div style="height: 300px;" class="row d-flex align-items-center">
                        <div class="col-12">
                            <h3 class="text-danger">Sorry, you need to log out before you can register a new account. Please log out and try again.</h3>
                        </div>
                    </div>';
                }
                else {
                    ...
                    <div class="col-12 mt-2">
                        <p>Already have an account? <a href="login.php" class="font-weight-bold">Login here!</a></p>
                    </div>
                </div>';
                }
            ?>
